...
INSERT INTO User (firstName, lastName, email, username, password, security_question, security_answer, school_year, major, category1, skill1, category2, skill2, category3, skill3, category4, skill4, category5, skill5) VALUES
('Ojas', 'Mhetar', 'ojmhetar@vt.edu', 'ojmhetar', 'password', '1', 'Answer', '4', 'Computer Science', 'Test', 'Test','Test','Test','Test','Test','Test','Test','Test','Test');
